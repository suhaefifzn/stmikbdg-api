...
<h4 class="fw-bold"><b>#</b> Android - KRS</h4>
<hr>
<div class="m-2">
    <ul class="nav nav-pills">
        <li class="nav-item">
            <div class="nav-link tab-link" style="cursor: pointer" data-tab="doswal">Dosen Wali</div>
        </li>
        <li class="nav-item">
...
<script>
    $(document).ready(() => {
        ...
        $('.tab-link').on('click', (e) => {
            ...
            $.ajax({
                url: '/docs/api/android/krs/tabs/' + tab,
                type: 'GET',
                beforeSend: () => {
